...
class StorageUnit(object):
    ...
    def __init__(self, name: str, contents, parent):
        ...
        self.SUID = IdGenerator.generate_id(5)
        logger.debug(f'Initializing storage unit with id {self.SUID}.')
    ...
    def set_contents(self, contents):
        ...
        logger.debug(f'Setting contents for storage unit with id {self.SUID}.')
    ...
    def _validate_name(self, name: str):
        ...
        logger.debug(f'Validating name for storage unit with id {self.SUID}.')
    ...
    def _validate_parent(self, parent):
        ...
        logger.debug(f'Validating parent for storage unit with id {self.SUID}.')
